...
var targetElement = document.querySelector('#burgermenu');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    openMenu: function openMenu() {
      ...
      var calcoloAltezza = window.innerHeight + 'px';
      tl.set('#burgermenu', {
        height: "0"
      }).set('#menuitems', {
        yPercent: 50,
...
/***/ "./resources/js/alpine/closemenu.js":
/*!******************************************!*\
  !*** ./resources/js/alpine/closemenu.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/alpine/loadToolkit.js":
/*!********************************************!*\
  !*** ./resources/js/alpine/loadToolkit.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    filteredEmployees: function filteredEmployees() {
      ...
      return this.searchData[0].filter(function (item) {
        return item.title.toLowerCase().includes(_this.search.toLowerCase());
      });
    },
    getData: function getData() {
      var that = this;
      axios.get('/api/collections/toolkit/entries').then(function (response) {
        // handle success
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    init: function init() {
      var bloccoIscrizione = $('#blocco-iscrizione').offset().top;
      // let bloccoTutor = $('#blocco-tutor').offset().top;
      var bloccoObblighi = $('#blocco-obblighi').offset().top;
      // let bloccoNormativa = $('#blocco-normativa').offset().top;
      var bloccoscadenze = $('#blocco-scadenze').offset().top;
      $(window).scroll(function () {
        var $el = $('.contenitoreScroll');
        var contenitoreScroll = $el.offset().top;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    inscroll: false,
    stickyElement: function stickyElement(fixedElement, elementToStartFor, fineScroll, navOrNot) {
      var yourNavigation = $(fixedElement);

      // Creo una variabile per calcolare l'offset nel caso il parametro non fosse passato 
      var elementOffset = 5000;
...
/* harmony import */ var _alpine_sticky_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alpine/sticky.js */ "./resources/js/alpine/sticky.js");
/* harmony import */ var _alpine_loadToolkit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alpine/loadToolkit.js */ "./resources/js/alpine/loadToolkit.js");
/* harmony import */ var _alpine_scroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./alpine/scroll.js */ "./resources/js/alpine/scroll.js");
/* harmony import */ var _alpine_burger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./alpine/burger.js */ "./resources/js/alpine/burger.js");
/* harmony import */ var _alpine_closemenu_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./alpine/closemenu.js */ "./resources/js/alpine/closemenu.js");
// This is all you.
...
// Li carico 
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('sticky', _alpine_sticky_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('loadToolkit', _alpine_loadToolkit_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('scroll', _alpine_scroll_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('burger', _alpine_burger_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('closemenu', _alpine_closemenu_js__WEBPACK_IMPORTED_MODULE_5__["default"]);
